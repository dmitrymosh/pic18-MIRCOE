...
const uint8_t PARTITION_ATTRIBUTES(ROOTDIRECTORY0_ADDRESS) RootDirectory0[FILEIO_CONFIG_MEDIA_SECTOR_SIZE]  ROOT_DIR_ADDR_TAG =
{
    ...
    /*
    'C','O','N','F','I','G',' ',' ',    //File name (exactly 8 characters)
    'C','F','G',                        //File extension (exactly 3 characters)
    ...
    0x10, 0x00, 0x00, 0x00, //File Size (number of bytes)
    */
};
...
{
    /*0x00,0x00,0x68,0x1,0x14,0x00,0xC8,0x00,0x10,0x00,0x20,0x00,0xF9,0x15*/
};
#endif
